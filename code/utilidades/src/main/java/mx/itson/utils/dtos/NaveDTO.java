...
public class NaveDTO implements Serializable {
    ...
    public void setOrientacion(OrientacionNave orientacion) {this.orientacion = orientacion;}

    public CoordenadaDTO[] getCoordenadas() {return coordenadas;}

    public void setCoordenadas(CoordenadaDTO[] coordenadas) {this.coordenadas = coordenadas;}
    ...
    public int getLongitudTotal() {return longitudTotal;}

    public void setLongitudTotal(int longitudTotal) {this.longitudTotal = longitudTotal;}
     ...
     * @return
     */
    public boolean estaHundida() {return impactosRecibidos >= longitudTotal;}
