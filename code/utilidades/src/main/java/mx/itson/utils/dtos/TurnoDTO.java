...
public class TurnoDTO implements Serializable {
    ...
    // Getters y Setters
    public String getNombreJugadorTurno() {return nombreJugadorTurno;}

    public void setNombreJugadorTurno(String nombreJugadorTurno) {this.nombreJugadorTurno = nombreJugadorTurno;}
    ...
    public void setPartidaEnCurso(boolean partidaEnCurso) {this.partidaEnCurso = partidaEnCurso;}
